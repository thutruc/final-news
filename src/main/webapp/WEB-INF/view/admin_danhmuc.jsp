			...
			<form id=form action="X
				...
				<table class="table1" border="2"
					...
					<tr class="tieude_table"
						...
						<th style="text-align: center; width: 120px;">Mã danh mục</th>
						<th style="text-align: center;">Tên danh mục</th>
						<th style="text-align: center;width: 50px;">Thêm</th>
 ...
 */						%>
 --%>
					<tr>
						...
						<td>
							<!-- link qua mã tin để xem tin chi tiết --> <a
							style="text-decoration: underline;"
							href="<%-- ActionDetailProduct.jsp?id=<%=/* list.get(i).getId() */%> --%>">
								<%-- <%=/* list.get(i).getId() */%> --%>
						</a> 123
						</td>
						<td style="height: 80px;">Tuyển sinh</td>
						<td></td>
