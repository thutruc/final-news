		...
		<div>
			...
			<div style="float: right; margin-bottom: 10px;">
				...
				<form action="" method="post" onsubmit="return SearchID2(this)">
					<input type="hidden" name="rep" value="viewID" /> Mã người dùng: <input
						name="id" id="id2" type="text"
						onkeypress="return numberonly(event);"
						style="width: 80px; margin-right: 10px;"> <input
						type="submit" class="UniXT" value="Tìm kiếm">
				</form>
			</div>
			...
			<form id=form action="Xulysuatintuc" method="post">
				...
				<table class="table1" border="2"
					...
					<tr class="tieude_table"
						...
						<th style="text-align: center; width: 35px;">Mã user</th>
						<th style="text-align: center; width: 85px;">Email</th>
						<th style="text-align: center; width: 85px;">Password</th>
						<th style="text-align: center; width: 42px;">Phân quyền</th>
						<th style="text-align: center; width: 40px;">Chỉnh sửa</th>
					...
					<tr style="font-size: 15px;">
						...
						<td>
							...
							list.get(i).getContent(), 50) */%> --%> Email...
						</td>
						<td>
							<%-- <%=/* list.get(i).getCutString(
							list.get(i).getContent(), 50) */%> --%> password...
						</td>
						<td>
							<%-- <%=/* list.get(i).getCutString(
							list.get(i).getContent(), 50) */%> --%> user
						</td>
			...
			<div style="margin-left: 70px;font-weight: bold;">Số lượng người dùng:</div>
