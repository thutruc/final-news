...
<body>
	<div id="container">
		...
		<div id="center">
			<div id="toptin">
				<jsp:include page="admin_sua_nguoidung.jsp"></jsp:include>
			</div>
		...
		<div id="footer">
			<div class="footer1">
				...
				<div style="width: 100%; height: 40px; color: #860f55;">
					...
					| &nbsp;<a href="" style="color: #027087; font-weight: bold;">Góc nhìn chuyên gia</a>&nbsp; | &nbsp;<a href=""
			...
			<div class="footer1">
				<p style="color: #032730; font-size: 15px;margin-top: -5px;">CHỊU TRÁCH NHIỆM BÀI
					VIẾT:</p>
