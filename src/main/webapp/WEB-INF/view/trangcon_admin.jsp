...
<title>Admin - web tin giáo dục</title>
...
<body>
	<div id="container">
		...
		<div id="center">
			<div id="toptin">
				<%-- <jsp:include page="admin_chuyenmuc.jsp"></jsp:include>  --%>
				<%-- <jsp:include page="admin_dangtin.jsp"></jsp:include>  --%>
				<%-- <jsp:include page="admin_dsbinhluan.jsp"></jsp:include>  --%>
				<jsp:include page="admin_dsnguoidung.jsp"></jsp:include>
				<%-- <jsp:include page="admin_sua_user.jsp"></jsp:include>  --%>
				<%-- <jsp:include page="admin_dstin.jsp"></jsp:include> --%>
				<%-- <jsp:include page="admin_hoidap.jsp"></jsp:include>  --%>
				<%-- <jsp:include page="admin_hosocanhan.jsp"></jsp:include>  --%>
			</div>
