...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/style_chitiettintuc.css">
...
<body>
	<div id="container">
		...
		<div id="menu">
			...
			<div id="login">
				<a href="http://localhost:8080/WebTinGiaoDuc/trangcon.jsp">Đăng
					nhập</a>
			</div>
		</div>
		<!-- end menu-->
			...
			<div id="top1">
				<div id="top_chitiet" style="border-bottom: none;">
					<div class="title_tinchitiet">
						<h2
							style="text-align: center; margin-left: 66px; font-size: 27px;">Người
					...
					<div id="noidung">
						<p>Vừa được Tổ chức Hỗ trợ sinh viên Nhật Bản (JASSO) công bố,
							...
							chức Hỗ trợ sinh viên Nhật Bản (JASSO) công bố, cho thấy lượng
							học viên, sinh viên Việt đứng thứ 2 về du học.</p>
						</br> </br>
						<p>Vừa được Tổ chức Hỗ trợ sinh viên Nhật Bản (JASSO) công bố,
							cho thấy lượng học viên, sinh viên Việt đứng thứ 2 về du học sinh
							ở Nhật, chỉ sau Trung Quốc (94.111, gần như không thay đổi so với
				...
				<div id="tinlienquan">
					<div id="tin" style="margin-bottom: 20px;">
						<div class="muc" >TIN LIÊN QUAN</div>
						<hr />
						<ul>
							<li><a href=""><strong> Tài liệu Những điều cần
										biết về tuyển sinh ĐH, CĐ 2015</strong></a></li>
							</br>
							<!--thamkhao: http://www.huongnghiepviet.com/v3/tin-huong-nghiep-tuyen-sinh -->
							<li><a href=""><strong>Thông tin xét tuyển của
										440 trường ĐH,CĐ trong cả nước 2016</strong></a></li>
							</br>
							<li><a href=""><strong>Chỉ tiêu tuyển sinh 2016
										của các trường CĐ, TC công an</strong></a></li>
						</ul>
				...
				<div id="binhluan"
					style="height: auto; margin: 38px; width: 69%;">
					<jsp:include page="binhluan.jsp"></jsp:include>
				</div>
			</div>
			<!--end binhluan_chitiet -->
		</div>
		<!--end center-->
